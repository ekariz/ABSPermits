...
<div class="col-md-6 form-group">
    ...
    <input type="text" class="form-control input-sm" name="legalofficername" id="legalofficername"  value="<?php echo $legalofficername; ?>"  placeholder=""   data-toggle="tooltip" data-placement="top" title="Institution Legal Officer Name">
    <div class="help-block with-errors"></div>
</div>

<div class="col-md-6 form-group">
    <label for="legalofficeremail">Institution Contact person Email</label>
    <input type="email" class="form-control input-sm" name="legalofficeremail" id="legalofficeremail"  value="<?php echo $legalofficeremail; ?>"  placeholder=""   data-toggle="tooltip" data-placement="top" title="Institution Legal Officer Email">
    <div class="help-block with-errors"></div>
</div>
