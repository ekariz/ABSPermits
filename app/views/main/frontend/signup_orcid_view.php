            ...
            <div class="breadcrumb-container">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">ORCID Authorization</li>
                    </ol>
                </div>
            </div>
            <!-- breadcrumb end -->
...
-->
                                    ...
                                    <div class="form-group">
                                       <a href="https://orcid.org/oauth/authorize?client_id=<?php echo $orcid_client_id;?>&response_type=code&scope=/<?php echo $orcid_scope;?>&family_names=<?php echo $lastname;?>&given_names=<?php echo $firstname;?>&email=<?php echo $email;?>&redirect_uri=<?php echo $orcid_redirect_uri;?>"  style="background-color:#A6CE39" class="btn btn-group btn-success btn-animated"><i class="ai ai-orcid  ai-1x"></i> create or Connect to your ORCID iD </a>
                                    </div>
