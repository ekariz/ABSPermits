        ...
        <link href="<?php  echo base_url();?>assets/frontend/plugins/rs-plugin/css/settings.css" rel="stylesheet">
        <link href="<?php  echo base_url();?>assets/frontend/plugins/owl-carousel/owl.carousel.css" rel="stylesheet">
        <link href="<?php  echo base_url();?>assets/frontend/plugins/owl-carousel/owl.transitions.css" rel="stylesheet">
