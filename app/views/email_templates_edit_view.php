  ...
  <div class="main" >
   ...
   <input type="hidden"  id="tmplref" name="tmplref" value="<?php echo $tmplref;?>" />
	 ...
	 <div class="form-body">
          ...
          <div class="form-group">
           <label class="col-sm-1 control-label" for="title">Name</label>
            <div class="col-sm-11">
             <input type="text" id="templatename" name="templatename"   class="form-control"  value="<?php echo $templatename; ?>" >
            </div>
          </div>
          ...
          <div class="form-group">
           <label class="col-sm-1 control-label" for="sectcode">Template </label>
            <div class="col-sm-11">
             <textarea type="text" id="template" name="template"   class="form-control" cols="80" rows="10" ><?php echo $template; ?></textarea>
            </div>
          </div>
    ...
    <div class="row">
	 ...
	 <div class="col-sm-11">
     <button type="button" id="btnSave" onclick="crud.save()" class="btn btn-success"><i class="fa fa-check"></i> Update</button>&nbsp; | &nbsp;
