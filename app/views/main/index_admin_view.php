    ...
    <body class="smart-style-6 minified fixed-header fixed-ribbon fixed-navigation fixed-page-footer">
        ...
        <header id="header">
            <div id="logo-group">
                ...
                <span id="logo"> <img src="<?php echo base_url();?>assets/img/logo.png" alt="Admin"> </span>
...
-->
        ...
        <script src="<?php echo base_url();?>assets/js/plugin/fancytree/jquery.fancytree-all.min.js"></script>
        ...
        <script>
            function open_app(appid){
             $.post('Admin/switch_to_app/'+appid, '', function(data) {
              if (data.success === 1) {
