...
<table class=" table-ruled table-bordered table-condensed">
 ...
 <tr>
  <td>&nbsp;</td>
  <td>
     <button id="btnPay"  class="btn btn-md  btn-success" onclick="payments.init_mpesa_stkpush('<?php echo $id; ?>','<?php echo $stepno; ?>');"><i class="fa fa-check"></i> Pay Now </button> |
     <a href="<?php  echo base_url();?>ApplicationsList/application/<?php echo $id; ?>" class="btn-link btn-sm  btn-default"><i class="fa fa-arrow-left"></i> Cancel </a>
  </td>
 </tr>
