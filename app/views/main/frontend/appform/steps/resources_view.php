...
<div class="col-md-12 form-group">
    <label for="resourcetype">Will you be Researching/Collecting a Genetic Resource,Genetic Information or Traditional Knowledge from Kenya?</label>
</div>

<div class="col-md-12 form-group">
    <?php echo form_dropdown('geneticresourcerc', $export_answer_list, $geneticresourcerc ,'id="geneticresourcerc" class="form-control  input-sm" onchange="handle_is_export();handle_export_docs();" required="required" ');  ?>
    <div class="help-block with-errors"></div>
</div>

<div class="col-md-12 form-group">
    <label for="resourcetype">Will you be Exporting a Genetic Resource,Genetic Information or Traditional Knowledge  from Kenya?</label>
</div>

<div class="col-md-12 form-group">
    <?php echo form_dropdown('exportanswer', $export_answer_list, $exportanswer ,'id="exportanswer" class="form-control  input-sm" onchange="handle_export_docs();" required="required" ');  ?>
    <div class="help-block with-errors"></div>
</div>
