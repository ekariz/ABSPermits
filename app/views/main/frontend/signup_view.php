                        ...
                        <div id="div-main" class="main object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="100">
                            <div class="form-block center-block p-30 light-gray-bg border-clear">
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group   has-feedback">
                                            <label class="control-label" for="titlecode">Title <span class="textRed">*</span></label>
                                            <?php echo form_dropdown('titlecode', $titles, '','id="titlecode" class="form-control" ');  ?>
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="form-group   has-feedback">
                                            <label class="control-label" for="lastname">First Name <span class="textRed">*</span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group   has-feedback">
                                            <label class="control-label" for="lastname">Last Name <span class="textRed">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group   has-feedback">
                                            <label class="control-label" for="gender">Gender <span class="textRed">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group   has-feedback">
                                            <label class="control-label" for="countrycode">Country <span class="textRed">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group   has-feedback">
                                            <label class="control-label" for="email">Email <span class="textRed">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group   has-feedback">
                                            <label class="control-label" for="mobile">Mobile <span class="textRed">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group   has-feedback">
                                            <label class="control-label" for="password">Password <span class="textRed">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group   has-feedback">
                                            <label class="control-label" for="passwordconfirm">Confirm Password <span class="textRed">*</span></label>
